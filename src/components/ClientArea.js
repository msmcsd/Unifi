	...
	return (
		...
		>
			<Grid
				item
				xs={1}
				md={2} // Column 1: displays install and download commands
			>
				<Grid container direction="column">
					{/* <InputArea variables={variables} /> */}
					<InstallArea variables={variables} />
					<DownloadArea />
					{/* <CommandList
						name="Install"
						list={installTasks}
						variant={CommandListType.Install}
					/>
					<CommandList
						key={downloadTask.name}
						name={downloadTask.name}
						list={downloadTask.commands}
						variant={CommandListType.Download}
					/> */}
				</Grid>
			</Grid>
			<Grid
				item
				xs={1}
				md={4} // Column 2: displays dos commands
			>
				<Grid
					container
					// spacing={0}
			...
			>
				...
				<Grid container direction="row">
					<Grid item xs={4}>
						<BatchCommandList tasks={batchTasks} />
					</Grid>
